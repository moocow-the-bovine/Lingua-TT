...
our $data = {};
our $dbf = tie(%$data, 'Tie::LevelDB', $dbfile)
  or die("$prog: could not open tie() LevelDB file '$dbfile': $!");
our $tied = $dbf;
...
tt-ldbapply.perl - apply LevelDB dictionary analyses to TT file(s)

=head1 SYNOPSIS

 tt-ldbapply.perl [OPTIONS] LEVELDB_FILE [TT_FILE(s)]
